...
const CommandSelfTest::TestCase *CommandSelfTest::directTests() const {
  static const TestCase tests[] = {
    ...
    {nullptr, "routinestatus", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    {nullptr, "routinelist", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    ...
    {nullptr, "dispenserstatus", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    {nullptr, "arm", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    {nullptr, "disarm", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    {"Dispense output pulse", nullptr, WaitKind::SKIP, 0, 0, SpecialAction::NONE, "requires an unloaded aircraft on the ground; use Dispense:<ms> manually"},
#endif
    ...
    {nullptr, "outputstatus", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    ...
    {nullptr, "gpio26:boot:on", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    {nullptr, "gpio26:boot:off", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    {nullptr, "dac1:timeoutms:500", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    {nullptr, "gpio26:timeoutsec:1", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    ...
    {nullptr, "gpio26:on", WaitKind::FIXED, QUICK_TIMEOUT_MS, 350, SpecialAction::NONE, nullptr},
    {nullptr, "gpio26:off", WaitKind::QUICK, QUICK_TIMEOUT_MS, QUICK_WAIT_MS, SpecialAction::NONE, nullptr},
    ...
    {nullptr, "gpio26:test3s", WaitKind::DAC, DAC_TIMEOUT_MS, 150, SpecialAction::NONE, nullptr},
...
void CommandSelfTest::start(CommandSource source, const String &requestId) {
  ...
  if (addon_.hasTimedOperationActive()) {
    publishStatus(EventLevel::ERROR, "[SELFTEST] start rejected: disarm or cancel timed addon state first", source, requestId);
    return;
  }
