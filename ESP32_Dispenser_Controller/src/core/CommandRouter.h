#ifndef ESP32_STEPPER_DUAL_DAC_COMMANDROUTER_H
#define ESP32_STEPPER_DUAL_DAC_COMMANDROUTER_H
...
class CommandRouter {
 public:
  ...
  void service();
  bool forceHardwareSafe(const String &reason);
...
#endif  // ESP32_STEPPER_DUAL_DAC_COMMANDROUTER_H
