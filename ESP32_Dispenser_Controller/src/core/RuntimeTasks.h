#ifndef ESP32_STEPPER_DUAL_DAC_RUNTIMETASKS_H
#define ESP32_STEPPER_DUAL_DAC_RUNTIMETASKS_H
...
class RuntimeTasks {
 ...
 private:
  ...
  bool radioSafetyApplied_;
};

#endif  // ESP32_STEPPER_DUAL_DAC_RUNTIMETASKS_H
