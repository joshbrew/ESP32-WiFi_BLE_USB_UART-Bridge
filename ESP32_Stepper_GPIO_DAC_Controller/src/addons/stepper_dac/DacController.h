...
// EDIT HERE to add DAC/GPIO commands, calibration behavior, boot policies, or
// new output channels. Keep hardware-independent command parsing in handleCommand(),
