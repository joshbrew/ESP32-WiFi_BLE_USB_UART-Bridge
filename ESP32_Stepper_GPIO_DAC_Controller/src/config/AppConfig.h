#ifndef ESP32_STEPPER_DUAL_DAC_APPCONFIG_H
#define ESP32_STEPPER_DUAL_DAC_APPCONFIG_H
...
constexpr const char *FIRMWARE_NAME = "ESP32 Stepper + DAC + GPIO Controller";
constexpr const char *FIRMWARE_VERSION = "2026-07-27-v5.15.44-dac1-gpio26";

constexpr int PIN_STEPPER_IN1 = 18;
constexpr int PIN_STEPPER_IN2 = 19;
constexpr int PIN_STEPPER_IN3 = 27;
constexpr int PIN_STEPPER_IN4 = 14;
...
constexpr int PIN_DAC_1 = 25;
constexpr int PIN_DIGITAL_OUTPUT = 26;
...
constexpr const char *CLASSIC_BT_NAME = "ESP32-StepperCmd";
constexpr const char *BLE_NAME = "ESP32-StepperBLE";
...
constexpr const char *DEFAULT_WIFI_AP_SSID = "ESP32-Stepper-WiFi";
constexpr const char *DEFAULT_WIFI_AP_PASSWORD = "stepper32";
constexpr const char *MDNS_HOSTNAME = "esp32-stepper";
...
constexpr bool RUN_DAC1_BOOT_TEST = true;
...
constexpr bool RUN_STEPPER_BOOT_TEST = true;
...
#endif  // ESP32_STEPPER_DUAL_DAC_APPCONFIG_H
