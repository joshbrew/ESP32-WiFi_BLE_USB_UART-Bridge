...
'''
    ...
    output = output.replace(
        ...
        "<title>ESP32 Stepper + Dual DAC Standalone Console</title>",
    )
...
def check_layout() -> None:
    ...
    required_root_files = {sketch.name, "build_opt.h"}
...
def check_markers_and_architecture() -> None:
    ...
    required: dict[str, list[str]] = {
        ...
        "src/config/AppConfig.h": [
            'FIRMWARE_VERSION = "2026-07-10-v5.15.43-led-gpio23-5"',
        ...
        "web/index.html": [
            ...
            'data-hold-on="DAC2:ON"', 'data-hold-off="DAC2:OFF"',
        ],
        "web/app.js": [
    ...
    if missing:
        fail("v5.15.43 architecture validation failed: " + "; ".join(missing))
...
def check_pin_map() -> None:
    ...
    print("OK: stepper, DAC, and indicator pin map is conflict-free")
