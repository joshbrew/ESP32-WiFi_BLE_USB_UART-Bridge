...
constexpr const char *FIRMWARE_VERSION = "2026-07-10-v5.15.43-led-gpio23-5";
...
constexpr int PIN_DAC_2 = 26;
constexpr uint8_t DAC_CHANNEL_COUNT = 2;
constexpr uint16_t DAC_DEFAULT_MV = 3300;
...
constexpr const char *DEFAULT_WIFI_AP_PASSWORD = "password";
